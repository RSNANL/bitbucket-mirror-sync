...
try {
    ...
    Write-Host 'Review and commit the configuration, deploy Worker, then run Test-Mirror.ps1 with -Dispatch followed by -ValidateSync and the source checkout path.'
}
finally {
